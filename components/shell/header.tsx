...
export function Header() {
  ...
  return (
    <Monitor className="col-span-3" contentClassName="py-0">
      <ChannelSwitch switchKey={channel.segment} severity="full" delayMs={0}>
        <div className="flex h-full items-center justify-between gap-4 whitespace-nowrap text-[13px]">
          ...
          <span className="flex min-w-0 items-center gap-4">
            ...
            <span className="shrink-0 text-[11px] text-green-bright">
              ● ONLINE
            </span>
          </span>
        </div>
